<?php   /*
    ...
    */
    ...
    ?>
        <!-- form start-->
            <form  target="_self" method="post" action="<?php echo $current_url?>" name="frmget_passwd" id="frmget_passwd">
                ...
                <tr>
                    <td colspan="2" class="errormessage_passwd" align="center" width="100%">
                       <?php echo $myuser->error_description; echo $passwd_error ;?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="right" class="passwd_caption" width="50%" ><b><?php echo $CAP_sec_que ?></b></td>
                    <td valign="top" align="left"  width="50%">
                    <?php
                ...
                <tr>
                    <td align="right" class="passwd_caption"  width="50%"><b><?php echo $CAP_sec_ans ?></b></td>
                    <td valign="top" align="left"  width="50%">
                ...
                <tr>
                    <td colspan="2" align="center"  width="100%">
                            <input value="<?php echo $CAP_submit ?>" type="submit" name="submit" onClick="return validate_get_passwd();" />
