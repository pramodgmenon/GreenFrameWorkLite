    ...
    ?>
        <!-- form start-->
            <form  target="_self" method="post" action="<?php echo $current_url?>" name="frmchange_passwd">
                ...
                <tr>
                    <td align="right" class="passwd_caption" ><b><?php echo $CAP_new_password ?></b></td>
                    <td valign="top" align="left">
                    <input class="passwd_box"  type="password" name="new_passwd" id="new_passwd" >
                    </td>
                </tr>
                <tr>
                    <td align="right" class="passwd_caption" ><b><?php echo $CAP_retype_password ?></b></td>
                    <td valign="top" align="left">
                    <input class="passwd_box"  type="password" name="retype_passwd" id="retype_passwd" ></td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
                            <input value="<?php echo $CAP_change ?>" type="submit" name="submit" onClick="return validate_change_passwd();" />
