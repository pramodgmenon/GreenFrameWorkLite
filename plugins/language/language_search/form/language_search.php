...
<table  align="center" style="text-align: left;" border="0" cellpadding="0" cellspacing="6" >
  <tbody>
    ...
    <tr>
     ...
     <tr>
      <td width="25%" align="right"><b><?php echo $CAP_search_language?></b></td>
      <td width="25%" align="left"><?php //loadsec_que("lstsec_que", -1, "Select Question",$_GET[lstsec_que],false,'style="width:210px; height:22;"');
            ...
            <input type="text" name="txtlanguage" id="txtlanguage" value="<?php echo $_GET["txtlanguage"] ?>" />
      </td>
    </tr>
     <tr>
      <td width="25%" align="right"><b><?php echo $CAP_publish?></b></td>
      <td width="25%" align="left">
            <input <?php if(isset($_GET["chkpublish"])){ ?> checked="true" <?php } ?> type="checkbox" name="chkpublish" id="chkpublish" value=<?php echo CONF_PUBLISH?>/>
     </td>
    </tr>
    ...
    <tr>
      <td colspan="2" align="center" width="100%"> <input name="submit" value="<?php echo $CAP_submit_search?>" type="submit"><input type="hidden" name="h_conf_search" value="<?php echo md5("CONF_SEARCH"); ?>"></td>
    </tr>
...
<table  width="100%"   align="center" border="0" cellpadding="1px" cellspacing="1px">
   ...
   <?php
    if ( $data_bylimit == false ){?>
     <tr><td colspan="3">&nbsp;</td></tr>
     <tr><td colspan="3" align="center" class="message" ><?php echo $mesg ?></td></tr>
     <tr><td colspan="3">&nbsp;</td></tr>
    <?php
     }
     else{?>
    <tr class="tableheader">
        <td></td>
        <td  align="center"><?php echo $CAP_language?></td>
        <td  align="center"><?php echo $CAP_publish?></td>
    </tr>
