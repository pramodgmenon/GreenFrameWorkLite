        <!-- form start-->
            <form  target="_self" method="post" action="<?php echo $current_url?>" name="frmguestbook">
                ...
                <tr>
                    <td colspan="2" class="errormessage_passwd" align="center" >
                       <?php echo $myuser->error_description; echo $guestbook_error ;?>
                    </td>
                </tr>
                <tr>
                    <td valign="bottom" align="right" class="passwd_caption"  ><b><?php echo $CAP_name ?></b></td>
                    <td valign="top" align="left">
                    <input style="width:200px;" type="text" name="txtname" id="txtname" value="" >
                    </td>
                </tr>
                <tr>
                    <td align="right" class="passwd_caption" ><b><?php echo $CAP_address ?></b></td>
                    <td valign="top" align="left">
                    <input style="width:200px;"  type="text" name="txtaddress" id="txtaddress" >
                    </td>
                </tr>
                <tr>
                    <td align="right" class="passwd_caption" ><b><?php echo $CAP_phone ?></b></td>
                    <td valign="top" align="left">
                    <input style="width:200px;"  type="text" name="txtphone" id="txtphone" ></td>
                </tr>
                <tr>
                    <td align="right" class="passwd_caption" ><b><?php echo $CAP_emailid ?></b></td>
                    <td valign="top" align="left">
                    <input style="width:200px;"  type="text" name="txtemailid" id="txtemailid" ></td>
                </tr>
                <tr>
                    <td align="right" class="passwd_caption" ><b><?php echo $CAP_subject ?></b></td>
                    <td valign="top" align="left">
                ...
                <tr>
                    <td colspan="2" align="center">
                            <input value="<?php echo $CAP_submit ?>" type="submit" name="submit" onClick="return validate_guestbook();" />
